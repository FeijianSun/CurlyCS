        ...
        return function(child) {
          ...
          if (child instanceof Block) {
            ...
            for (i = j = 0, len1 = ref3.length; j < len1; i = ++j) {
              ...
              } else if (node instanceof Value && node.isObject(false)) {
                cont = false;
    ...
    Op.prototype.invert = function() {
      ...
      if (this.isChainable() && this.first.isChainable()) {
        ...
        while (curr && curr.operator) {
          allInvertable && (allInvertable = curr.operator in this.INVERSIONS);
          curr = curr.first;
        }
        if (!allInvertable) {
        ...
        while (curr && curr.operator) {
          ...
          curr.operator = this.INVERSIONS[curr.operator];
          curr = curr.first;
        }
        return this;
      } else if (op = this.INVERSIONS[this.operator]) {
        this.operator = op;
