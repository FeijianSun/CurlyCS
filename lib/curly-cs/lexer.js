...
(function() {
  var BOM, BOOL, CALLABLE, CCS_ALIASES, CCS_ALIAS_MAP, CCS_KEYWORDS, CODE, COMMENT, COMPARE, COMPOUND_ASSIGN, HERECOMMENT_ILLEGAL, HEREDOC_DOUBLE, HEREDOC_INDENT, HEREDOC_SINGLE, HEREGEX, HEREGEX_OMIT, IDENTIFIER, INDEXABLE, INVALID_ESCAPE, INVERSES, JSTOKEN, JS_FORBIDDEN, JS_KEYWORDS, LEADING_BLANK_LINE, LINE_BREAK, LINE_CONTINUER, LOGIC, Lexer, MATH, MULTI_DENT, NOT_REGEX, NUMBER, OPERATOR, POSSIBLY_DIVISION, REGEX, REGEX_FLAGS, REGEX_ILLEGAL, RELATION, RESERVED, Rewriter, SHIFT, SIMPLE_STRING_OMIT, STRICT_PROSCRIBED, STRING_DOUBLE, STRING_OMIT, STRING_SINGLE, STRING_START, TRAILING_BLANK_LINE, TRAILING_SPACES, UNARY, UNARY_MATH, VALID_FLAGS, WHITESPACE, compact, count, invertLiterate, key, locationDataToString, ref, ref1, repeat, starts, throwSyntaxError,
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.identifierToken = function() {
      ...
      tag = 'IDENTIFIER';
      if (!forcedIdentifier && (indexOf.call(JS_KEYWORDS, id) >= 0 || indexOf.call(CCS_KEYWORDS, id) >= 0)) {
        tag = id.toUpperCase();
      ...
      if (!forcedIdentifier) {
        if (indexOf.call(CCS_ALIASES, id) >= 0) {
          alias = id;
          id = CCS_ALIAS_MAP[id];
        }
        tag = (function() {
    ...
    Lexer.prototype.literalToken = function() {
      ...
      if (value === ';') {
        ...
        tag = 'SHIFT';
      } else if (indexOf.call(LOGIC, value) >= 0 || value === '??') {
        tag = 'LOGIC';
      } else if (value === '{') {
        tag = 'BLOCK_START';
      } else if (value === '}') {
  ...
  CCS_KEYWORDS = ['undefined', 'then', 'unless', 'until', 'loop', 'of', 'by', 'when'];
  ...
  CCS_ALIASES = (function() {
    var results;
    results = [];
    for (key in CCS_ALIAS_MAP) {
      results.push(key);
    }
    return results;
  })();

  CCS_KEYWORDS = CCS_KEYWORDS.concat(CCS_ALIASES);
  ...
  exports.RESERVED = RESERVED.concat(JS_KEYWORDS).concat(CCS_KEYWORDS).concat(STRICT_PROSCRIBED);
  ...
  LINE_BREAK = ['BLOCK_START', 'BLOCK_END', 'TERMINATOR'];
