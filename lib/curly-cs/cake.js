...
(function() {
  var CurlyCS, cakefileDirectory, fatalError, fs, helpers, missingTask, oparse, options, optparse, path, printTasks, switches, tasks;
  ...
  exports.run = function() {
    ...
    CurlyCS.run(fs.readFileSync('Cakefile').toString(), {
      filename: 'Cakefile'
    });
