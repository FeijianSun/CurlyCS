...
(function() {
  ...
  grammar = {
    ...
    Block: [
      o('BLOCK_START BLOCK_END', function() {
        return new Block;
      }), o('BLOCK_START Body BLOCK_END', function() {
        return $2;
      })
    ],
    Identifier: [
    ...
    AssignObj: [
      o(': ObjAssignable', function() {
        ...
        return new Assign(LOC(2)(new Value($2)), $4, null, {
          operatorToken: LOC(3)(new Literal($3))
        });
      })
    ],
    ...
    Object: [
      o('OBJ_START AssignList OBJ_END', function() {
    ...
    Class: [
      ...
      }), o('CLASS EXTENDS SimpleAssignable', function() {
        return new Class(null, $3);
      }), o('CLASS EXTENDS SimpleAssignable Block', function() {
        return new Class(null, $3, $4);
      }), o('CLASS SimpleAssignable', function() {
        return new Class($2);
      }), o('CLASS SimpleAssignable Block', function() {
        return new Class($2, null, $3);
      }), o('CLASS SimpleAssignable EXTENDS SimpleAssignable', function() {
        return new Class($2, $4);
      }), o('CLASS SimpleAssignable EXTENDS SimpleAssignable Block', function() {
    ...
    Switch: [
      o('SWITCH Expression BLOCK_START Whens BLOCK_END', function() {
        return new Switch($2, $4);
      }), o('SWITCH Expression BLOCK_START Whens ELSE Block BLOCK_END', function() {
        return new Switch($2, $4, $6);
      }), o('SWITCH BLOCK_START Whens BLOCK_END', function() {
        return new Switch(null, $3);
      }), o('SWITCH BLOCK_START Whens ELSE Block BLOCK_END', function() {
    ...
    Operation: [
      ...
      }), o('SimpleAssignable EXTENDS SimpleAssignable', function() {
        return new Extends($1, $3);
      })
    ]
  };

  operators = [['left', '.', '?.', '::', '?::'], ['left', 'CALL_START', 'CALL_END'], ['nonassoc', '++', '--'], ['left', '?'], ['right', 'UNARY'], ['right', '**'], ['right', 'UNARY_MATH'], ['left', 'MATH'], ['left', '+', '-'], ['left', 'SHIFT'], ['left', 'RELATION'], ['left', 'COMPARE'], ['left', 'LOGIC'], ['nonassoc', 'BLOCK_START', 'BLOCK_END'], ['right', 'YIELD'], ['right', '=', ':', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS'], ['right', 'FORIN', 'FOROF', 'BY', 'WHEN'], ['right', 'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS'], ['left', 'POST_IF']];
