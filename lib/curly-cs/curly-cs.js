...
(function() {
  ...
  exports.VERSION = '0.01.1';

  exports.FILE_EXTENSIONS = ['.ccs', '.litccs', '.ccs.md'];
  ...
  exports.compile = compile = withPrettyErrors(function(code, options) {
    ...
    if (options.header) {
      header = "Generated by CurlyCS " + this.VERSION;
      js = "// " + header + "\n" + js;
    }
    if (generateSourceMap) {
    ...
    if (options.inlineMap) {
      ...
      sourceURL = "//# sourceURL=" + ((ref = options.filename) != null ? ref : 'curlycs');
      js = js + "\n" + sourceMapDataURI + "\n" + sourceURL;
    }
  ...
  exports.run = function(code, options) {
    ...
    if (!helpers.isCCS(mainModule.filename) || require.extensions) {
  ...
  if (require.extensions) {
    ...
    fn1 = function(ext) {
      ...
      return (base = require.extensions)[ext] != null ? base[ext] : base[ext] = function() {
        throw new Error("Use CurlyCS.register() or require the curly-cs/register module to require " + ext + " files.");
      };
    };
